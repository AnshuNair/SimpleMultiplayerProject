			...
			while (emperorPlayed == false && slavePlayed == false) 
			{
				...
				if (!hasAuthority) 
				{
					if (isServer) 
					{
						if (DidClientPlayOne ()) 
						{
							guidelines.text = "After the waitUntil. The CLIENT played a card";
							CmdCheckPlayZones ();
							whoPlayedOne = 2;
						}
					}
				...
				if (!hasAuthority) 
				{
					if (isServer) 
					{
						if (DidHostPlayOne ()) 
						{
							guidelines.text = "After the waitUntil. The HOST played a card";
							CmdCheckPlayZones ();
							whoPlayedOne = 1;
						}
					}
				...
				else if (emperorPlayed == true || slavePlayed == true) 
				{
					...
					yield return new WaitUntil (() => hostDisplayedAgain == true);

					Debug.Log ("Now displaying hand for Client...");

					if (!hasAuthority) 
					{
						if (isServer) 
							CmdDisplayHandForClient ();
					}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void RpcDisplayHandsAgain()
	{
		if (!isServer) 
		{
			Debug.Log ("Trying to display hand again for the Client");
